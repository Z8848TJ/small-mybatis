...
import com.zzh.mybatis.reflection.invoker.GetFieldInvoker;
import com.zzh.mybatis.reflection.invoker.Invoker;
import com.zzh.mybatis.reflection.invoker.MethodInvoker;
import com.zzh.mybatis.reflection.invoker.SetFieldInvoker;
...
public class Reflector {
    ...
    // set 方法列表 key: 属性名 value: set 方法对应的 Method 对象
    private Map<String, Invoker> setMethods = new HashMap<>();
    
    // get 方法列表 key: 属性名 value: get 方法对应的 Method 对象
    private Map<String, Invoker> getMethods = new HashMap<>();
    
    // set 类型列表 key: 属性名 value: 属性对一个的 Field 对象
    private Map<String, Class<?>> setTypes = new HashMap<>();
    
    // get 类型列表 key: 属性名 value: 属性对一个的 Field 对象
    private Map<String, Class<?>> getTypes = new HashMap<>();
    
    // 构造函数
    private Constructor<?> defaultConstructor;

    // key: 全大写的属性名 value: 属性名
    ...
    public Reflector(Class<?> clazz) {
        ...
        // 加入 getter Map<String, Invoker> getMethods
        addGetMethods(clazz);
        // 加入 setter Map<String, Invoker> getMethods = new HashMap<>();
        addSetMethods(clazz);
        // 加入字段
        addFields(clazz);
        // get 属性列表
     ...
     *
     * @param clazz The class for which to look up the method cache.
